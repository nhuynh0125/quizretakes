 ...
 */
/*
 * ***************************************** <quizzes> <quiz> <id>1</id>
 * --integer > 0 <dateGiven> <month>1</month> --01..12 <day>10</day> --1..31
 * <hour>15</hour> --0..23 <minute>30</minute> --> 0-59 </dateGiven> </quiz>
 * <quiz> <id>2</id> ... </quizzes>
 */
...
public class quizBean implements Comparable<quizBean> {
	...
	public String toString() {
		return ID + ": " + dateGiven.toString() + ": " + dateGiven.getDayOfWeek() + ": " + timeGiven.toString();
	}
