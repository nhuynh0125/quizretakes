 ...
 */
/*
 * ***************************************** <retakes> <retake> <id>1</id> <!--
 * Should be unique and in order --> <location>Inn 204</location> --String,
 * building & room <whenOffered> <month>2</month> --01..12 <day>7</day> --1..31
 * <hour>10</hour> --0..23 <minute>00</minute> --> 0-59 </whenOffered> </retake>
 * <retake> <id>2</id> ... </retakes>
 */
...
public class retakeBean implements Comparable<retakeBean> {
	...
	public String toString() {
		return retakeID + ": " + location + ": " + whenOffered.toString() + ": " + whenOffered.getDayOfWeek() + ": "
